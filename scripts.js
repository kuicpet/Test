...
const loadData = () => {
  ...
  const license = loadedData.data.repositoryOwner.repositories.edges;
  console.log(license)
  // get User profile
  ...
  arr.flatMap((item) => {
    ...
    <div class="d-inline">
        <h3 class="repo_name">
            <a href="" class="repo_link">Test</a>
        </h3>
    </div>
    <div>
        <p class="d-inline repo_description">Sample test</p>
    </div>
    <div>
        <a href="tags">tags</a>
        <a href="tags">tags</a>
    ...
    <div class="repo_details">
        <span class="ml-0 mr-3">
            <span class="repo_lang_color" style="background-color: #f1e05a"></span>
            <span class="repo_lang">HTML</span>
        </span>
        <span class="mr-3">
        ...
        Updated <time class="no-wrap">Nov 2020</time>
    </div>
</div>
<div class="repo_star">
    <div class="text-right">
        <button class="btn-sm">
            <svg class="octicon octicon-star-fill" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25z"></path></svg>Star
        </button>
    </div>
</div>
     `
